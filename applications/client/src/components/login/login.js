...
export default function LogIn() {
    return (
        <div className="log-in flex-col-hstart-vstart clip-contents">
            ...
            <div className="group-075 flex-row">
                <p className="txt-362">Password</p>
                <img
                    src="https://firebasestorage.googleapis.com/v0/b/unify-bc2ad.appspot.com/o/imw3m18q89-517%3A21?alt=media&token=320d3142-ce1b-4b28-ab13-6b2a2a936cc8"
                    alt="Not Found"
                    className="visibility-23"
                />
            </div>
            <div className="group-467">
                <p className="txt-8109">Email Address</p>
            </div>
            ...
            <div className="frame-14 flex-row-vstart-hstart">
                <p className="txt-196 flex-hcenter">Log In</p>
            </div>
            <img
